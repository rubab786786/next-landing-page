...
const HowItLooks = () => {
  ...
  return (
    <>
      ...
      <section id="how-it-looks" className="feature-section">
        <div
          className="w-layout-blockcontainer feature-container w-container"
          style={{
        ...
        >
          ...
          >
            Crafted with simplicity and elegance, our interface ensures a smooth
            and enjoyable experience for both desktop and mobile users alike.
          </p>
          <div
